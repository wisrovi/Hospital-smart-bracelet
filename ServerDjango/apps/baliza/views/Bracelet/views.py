...
from apps.baliza.models import InstalacionBaliza, Baliza, BraceletUmbrals, Bracelet
from apps.baliza.views.Bracelet.forms import CreateBraceletForm
                ...
                if forms.is_valid():
                    ...
                    if len(mac_bracelet) == 17:
                        ...
                        if bracelet_major > 0 \
                            ...
                            data['error'] = 'Los datos de fabricación deben estar como números positivos (no se admite el valor 0).'
                    else:
